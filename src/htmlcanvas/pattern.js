...
export function CanvasPattern(image, repetition) {
  this._shader = null;
  ...
  this._image = image;
  this._transform = matrixFunc.identity();
  ...
  switch (repetition) {
    case 'repeat-x':
      ...
      this._tileY = TileMode.Decal;
      break;
    case 'repeat-y':
      this._tileX = TileMode.Decal;
      this._tileY = TileMode.Repeat;
      break;
    case 'repeat':
      this._tileX = TileMode.Repeat;
      this._tileY = TileMode.Repeat;
